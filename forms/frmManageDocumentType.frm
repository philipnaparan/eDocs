...
Begin VB.Form frmManageDocumentType 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Manage Document Type"
   ClientHeight    =   6150
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   6420
   ...
   EndProperty
   Icon            =   "frmManageDocumentType.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6150
   ...
   Begin MSComctlLib.ImageList imgDocIco16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManageDocumentType.frx":038A
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Image Image1 
      Height          =   360
      Left            =   225
      Picture         =   "frmManageDocumentType.frx":0724
      Top             =   150
      Width           =   360
   End
   ...
   End
End
Attribute VB_Name = "frmManageDocumentType"
...
Private Sub cmdDelete_Click()
    ...
    If MsgBox("Are you sure you want to delete the record named '" & lstvRecordList.SelectedItem.Text & "'?", vbCritical + vbYesNo, "Confirm Deletion") = vbYes Then
        ...
        If ExecSQL("DELETE tbl_DocType WHERE [ID]=" & lstvRecordList.SelectedItem.Tag & "") = True Then
...
Private Sub cmdEdit_Click()
    ...
    frmManageDocumentTypeAddEdit.lPK = Val(lstvRecordList.SelectedItem.Tag)
    frmManageDocumentTypeAddEdit.Show vbModal
    
    If Not LastRecordsetA Is Nothing Then UpdateListView lstvRecordList, LastRecordsetA, 1, "ID", "TypeName", , , , , , False
    Set LastRecordsetA = Nothing
End Sub

Private Sub cmdNew_Click()
    Set LastRecordsetA = Nothing
    frmManageDocumentTypeAddEdit.lPK = 0
    frmManageDocumentTypeAddEdit.Show vbModal
    
    If Not LastRecordsetA Is Nothing Then UpdateListView lstvRecordList, LastRecordsetA, 1, "ID", "TypeName", , , , , , True
    Set LastRecordsetA = Nothing
End Sub
...
Private Sub LoadGroupList()
    ...
    Set rsGroup = GetRecords("SELECT TypeName,ID FROM tbl_DocType")
    
    If Not rsGroup Is Nothing Then
        If rsGroup.RecordCount > 0 Then
            DisableEditing True
            
            FillListView lstvRecordList, rsGroup, 1, 1, False, True, "ID", "TypeName"
        Else
            DisableEditing
        End If
    End If
