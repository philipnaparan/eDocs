...
Begin VB.Form frmManageUserSubGroup 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "User Sub-Group Manager"
   ClientHeight    =   6150
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   6420
   ...
   EndProperty
   Icon            =   "frmManageUserSubGroup.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6150
   ...
   Begin MSComctlLib.ImageList imgDocIco16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmManageUserSubGroup.frx":038A
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Image Image1 
      Height          =   360
      Left            =   225
      Picture         =   "frmManageUserSubGroup.frx":0724
      Top             =   150
      Width           =   360
   End
   Begin VB.Label lblTitle 
      BackStyle       =   0  'Transparent
      Caption         =   "Manage User Sub-Group"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   14.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmManageUserSubGroup"
...
Private Sub LoadGroupList()
    ...
    Set rsGroup = GetRecords("SELECT GroupName,ID FROM tbl_UserGroup")
