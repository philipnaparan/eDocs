...
Public Event FrameChanged(ByVal FrameIndex As Long) ' fired each time a frame is rendered
...
Private Sub UserControl_Show()
    If c_aniState = gfaPause Then ManageTimers 1 ' start timer if not already started
End Sub
